...
const multipleAuthorsWithMaxBlogs = [
  {
    _id: "5a422a851b54a676234d17f1",
    title: "Was it worth it?",
    author: "Cadence",
    url: "https://verbosecode.com/",
    likes: 42.0,
    __v: 0
  },
  {
...
const edgeCaseOfAuthorWithMultipleBlogsWithMostLikes = [
  {
    _id: "5a422a851b54a676234d17f7",
    title: "React patterns",
    author: "Michael Chan",
...
describe('author(s) with most blogs', () => {
  test('of empty list is zero', () => {
    const result = listHelper.authorWithMostBlogs(zeroBlogs)
    expect(result).toEqual(null)
  })
  ...
  test('the max number of blogs authored is the same among multiple authors', () => {
    const result = listHelper.authorWithMostBlogs(multipleAuthorsWithMaxBlogs)
    expect(result).toEqual({
...
describe('blog with most likes', () => {
  ...
  test('if authors share most likes', () => {
    const result = listHelper.mostLikes(authorsShareMostLikes)
    expect(result).toEqual({
      authors: ["Edsger W. Dijkstra", "Robert C. Martin"],
      likes: 12
    })
  ...
  test('if an author or authors have more than one blog that has max likes and more than one author has most likes', () => {
    const result = listHelper.mostLikes(edgeCaseOfAuthorWithMultipleBlogsWithMostLikes)
    expect(result).toEqual({
      authors: ["Edsger W. Dijkstra", "Robert C. Martin"],
      likes: 12
    })
